...
<div x-data="articleForm">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h1 class="h3 mb-0 mt-2">Créer un article</h1>
        </div>
    </div>
    ...
    <!-- Formulaire -->
    <form id="articleForm" action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data" @submit.prevent="submitForm">
        @csrf
