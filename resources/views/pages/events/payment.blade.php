...
<div class="min-h-screen bg-white mt-20">
    ...
    <!-- Les notifications sont gérées automatiquement par le layout principal -->
...
<script>
    function initiatePayment() {
        ...
        .then(data => {
            if (data.status === 'success') {
                ...
                showToast("{{ __("Une erreur est survenue. Veuillez réessayer.") }}", 'error');
            }
        })
        .catch(error => {
    ...
    // Les flash messages sont maintenant gérés automatiquement par le système unifié
</script>
@endpush
