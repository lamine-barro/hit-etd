...
@section('title', 'Créer un expert')
@section('page-title', 'Créer un expert')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-3 text-sm text-gray-500 mb-4">
            ...
            <span class="text-gray-900">Nouvel expert</span>
        </div>
        <h1 class="text-2xl font-semibold text-gray-900 font-poppins">Créer un nouvel expert</h1>
        <p class="mt-2 text-sm text-gray-600">Remplissez les informations ci-dessous pour créer un nouvel expert.</p>
    </div>
                                ...
                                @foreach(\App\Models\Expert::SPECIALTIES as $key => $label)
                                    <div class="flex items-center">
                                        <input type="checkbox" 
                                               ...
                                               id="specialty_{{ $key }}" 
                                               value="{{ $key }}"
                                               {{ is_array(old('specialties')) && in_array($key, old('specialties')) ? 'checked' : '' }}
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-2">
                                <textarea name="bio" 
                                          ...
                                          placeholder="Décrivez l'expertise, l'expérience et les réalisations de l'expert...">{{ old('bio') }}</textarea>
                                @error('bio')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <textarea name="intervention_areas" 
                                          ...
                                          placeholder="Mentoring, Formation, Conseil stratégique, Accompagnement technique...">{{ old('intervention_areas') }}</textarea>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <select name="availability" 
                                        ...
                                        <option value="immediate" {{ old('availability') == 'immediate' ? 'selected' : '' }}>Immédiate</option>
                                        <option value="1_week" {{ old('availability') == '1_week' ? 'selected' : '' }}>Dans 1 semaine</option>
                                        <option value="2_weeks" {{ old('availability') == '2_weeks' ? 'selected' : '' }}>Dans 2 semaines</option>
                                        <option value="1_month" {{ old('availability') == '1_month' ? 'selected' : '' }}>Dans 1 mois</option>
                                        <option value="limited" {{ old('availability') == 'limited' ? 'selected' : '' }}>Limitée</option>
                                    </select>
                                    @error('availability')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-2">
                                <textarea name="availability_notes" 
                                          ...
                                          placeholder="Précisions sur la disponibilité, créneaux préférés...">{{ old('availability_notes') }}</textarea>
