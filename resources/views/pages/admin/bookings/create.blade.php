...
@section('title', 'Créer une demande de visite')
@section('page-title', 'Créer une demande de visite')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-3 text-sm text-gray-500 mb-4">
            ...
            <span class="text-gray-900">Nouvelle demande</span>
        </div>
        <h1 class="text-2xl font-semibold text-gray-900 font-poppins">Créer une nouvelle demande de visite</h1>
        <p class="mt-2 text-sm text-gray-600">Remplissez les informations ci-dessous pour créer une nouvelle demande de visite.</p>
    </div>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <select name="visit_type" 
                                        ...
                                        <option value="discovery" {{ old('visit_type') == 'discovery' ? 'selected' : '' }}>Visite découverte</option>
                                        <option value="business" {{ old('visit_type') == 'business' ? 'selected' : '' }}>Visite d'affaires</option>
                                        <option value="partnership" {{ old('visit_type') == 'partnership' ? 'selected' : '' }}>Partenariat</option>
                                        <option value="investment" {{ old('visit_type') == 'investment' ? 'selected' : '' }}>Investissement</option>
                                        <option value="other" {{ old('visit_type') == 'other' ? 'selected' : '' }}>Autre</option>
                                    </select>
                                    @error('visit_type')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            @foreach($spaces_options as $space)
                                <div class="flex items-center">
                                    <input type="checkbox" 
                                           ...
                                           value="{{ $space }}"
                                           {{ is_array(old('spaces')) && in_array($space, old('spaces')) ? 'checked' : '' }}
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-2">
                                <select name="purpose" 
                                    ...
                                    <option value="Découvrir l'écosystème" {{ old('purpose') == "Découvrir l'écosystème" ? 'selected' : '' }}>Découvrir l'écosystème</option>
                                    <option value="Explorer les espaces disponibles" {{ old('purpose') == "Explorer les espaces disponibles" ? 'selected' : '' }}>Explorer les espaces disponibles</option>
                                    <option value="Rencontrer des startups" {{ old('purpose') == "Rencontrer des startups" ? 'selected' : '' }}>Rencontrer des startups</option>
                                    <option value="Évaluer les opportunités de partenariat" {{ old('purpose') == "Évaluer les opportunités de partenariat" ? 'selected' : '' }}>Évaluer les opportunités de partenariat</option>
                                    <option value="Considérer un investissement" {{ old('purpose') == "Considérer un investissement" ? 'selected' : '' }}>Considérer un investissement</option>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <textarea name="message" 
                                          ...
                                          placeholder="Informations supplémentaires ou demandes spéciales...">{{ old('message') }}</textarea>
                                @error('message')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
