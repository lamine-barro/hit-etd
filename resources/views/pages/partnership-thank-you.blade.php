    ...
    <div class="pt-32 pb-12 bg-gradient-to-r from-primary-600 to-primary-800">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-white/90 max-w-2xl mx-auto">
                Votre demande de partenariat a été enregistrée avec succès
            </p>
        </div>
    </div>
        ...
        <div class="max-w-3xl mx-auto text-center">
            <div class="bg-white rounded-xl shadow-sm border p-8 mb-8">
                ...
                <p class="text-gray-600 mb-6">
                    Nous avons bien reçu votre demande de partenariat. Notre équipe va l'étudier attentivement et vous recontactera dans les plus brefs délais.
                </p>
                ...
                <div class="border-t border-gray-200 pt-6 mt-6">
                    ...
                    <ul class="space-y-4 text-left">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-600">Notre équipe examinera votre demande sous 48 heures ouvrées</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-primary-500 mt-1 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                            </svg>
                            <span class="text-gray-600">Vous serez contacté par email ou téléphone pour discuter des détails</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-primary-500 mt-1 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path>
                            </svg>
                            <span class="text-gray-600">Une réunion pourra être planifiée pour définir les modalités du partenariat</span>
                        </li>
                    </ul>
                </div>
            </div>
