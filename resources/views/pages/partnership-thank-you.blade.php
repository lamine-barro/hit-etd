...
@section('title', __("Merci pour votre demande de partenariat - HIT"))
@section('meta_description', __("Merci pour votre demande de partenariat avec le HIT. Notre équipe va étudier votre demande et vous recontactera prochainement."))
