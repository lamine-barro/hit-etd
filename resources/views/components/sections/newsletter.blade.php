                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div class="relative group">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="newsletter_name" id="newsletter_name" class="block w-full pl-11 pr-4 py-3.5 rounded-xl border border-gray-300 bg-white focus:ring-primary-500 focus:border-primary-500 focus:outline-none transition duration-200 placeholder-gray-400 shadow-sm" placeholder="{{ __("Votre nom complet") }}">
                        </div>
                    </div>
