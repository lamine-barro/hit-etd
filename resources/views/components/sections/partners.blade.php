    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-16 text-center">
            <div class="inline-flex flex-col items-center bg-white p-6 rounded-xl shadow-lg transform hover:-translate-y-1 transition-all duration-300">
                ...
                <a href="{{ route('applications') }}#partnership" class="group inline-flex items-center px-6 py-3 text-base font-semibold rounded-lg text-white bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 transition-all duration-300 shadow-md hover:shadow-xl transform hover:-translate-y-0.5">
                    {{ __("Devenir Donateur") }}
