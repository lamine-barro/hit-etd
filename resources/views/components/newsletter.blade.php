...
<section class="relative py-24 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border-t border-gray-200">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="relative p-5 bg-white border rounded-2 transition-all duration-200 group cursor-pointer">
                            <div class="flex justify-between items-center mb-2">
                                <label for="newsletter_whatsapp" class="font-semibold text-gray-900 group-hover:text-green-600 transition-colors duration-200 cursor-pointer">{{ __('Alertes WhatsApp') }}</label>
        ...
        <div class="mt-8 text-center">
            <p class="text-sm text-gray-600 max-w-xl mx-auto">{{ __('En vous inscrivant, vous acceptez de recevoir nos communications selon vos préférences.') }} <br class="hidden sm:inline">{{ __('Vous pourrez vous désinscrire à tout moment en cliquant sur le lien présent dans nos emails.') }}</p>
